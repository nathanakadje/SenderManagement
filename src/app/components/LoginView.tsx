...
export function LoginView({ onLoginSuccess }: LoginViewProps) {
  ...
  // Charger une image de fond aléatoire ou fixe
  useEffect(() => {
    // Vous pouvez choisir une image fixe ou aléatoire
    // Option 1: Image fixe
    setBackgroundImage('https://images.unsplash.com/photo-1497215728101-856f4ea42174?w=1920&h=1080&fit=crop');
    
    // Option 2: Image aléatoire depuis Unsplash (décommentez pour utiliser)
  ...
  const translations = {
    Fr: {
      ...
      support: 'support@arolitec.com',
      copyright: 'All rights reserved © Arolitec Technologies 2026',
      marketingTitle: 'Simplifiez la gestion de des senders.',
      marketingText: 'Centralisez la gestion des senders, suivez les traitements en temps réel et garder le contrôle sur chaque étape du processus.',
  ...
  return (
    ...
    >
      ...
      <div 
        className="main-card flex flex-col md:flex-row bg-white" 
        style={{ 
          width: '100%', 
          maxWidth: '1100px', 
          minHeight: '700px', 
      ...
      >
        {/* Left Section - Form */}
        <section className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-between relative" style={{ background: 'rgba(255, 255, 255, 0.95)' }}>
          {/* Header */}
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8" style={{ background: '#5fabce', borderRadius: '0.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <div className="w-4 h-4 bg-white rounded-sm"></div>
              </div>
              <span className="font-heading font-extrabold text-2xl tracking-tight" style={{ color: '#1e293b' }}>Arolitec</span>
            </div>
            <button
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <footer className="mt-12 text-center text-sm">
              ...
              <a href="mailto:support@arolitec.com" className="font-semibold hover:underline" style={{ color: '#0ea5e9' }}>
                {t.support}
              </a>
            </footer>
          </div>
        ...
        {/* Right Section - Visual - Version corrigée sans spinner */}
        <section className="hidden md:block w-1/2 relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            ...
            >
              {/* Suppression du spinner qui tournait */}
              {/* <div className="mb-6">
              ...
              {/* Icône de remplacement (optionnelle) */}
              <div className="mb-6">
